          ...
          <div className="lg:col-span-3">
            ...
            <div className="flex items-center gap-3">
              <a
                ...
                className="w-11 h-11 bg-gray-800/50 border border-gray-700 rounded-xl flex items-center justify-center text-gray-400 hover:bg-amber-600 hover:border-amber-600 hover:text-white transition-all duration-300"
                aria-label="Facebook"
              >
                <FacebookIcon />
              </a>
